            ...
            <View
              ...
              <View>
                ...
                <View style={[styles.registerInputStyle, {marginBottom:4, borderColor: userPasswordError ? '#ff0000' : '#015096',}]}>                  
                  ...
                  <TextInput
                    style={Platform.OS == 'ios' ? styles.inputIos 
                      : styles.inputAndroid  }
                  ...
                  <View style={[styles.registerInputStyle, {borderColor: '#EBEBEB',}]}>                  
                  <Text
                    style={[
                      styles.inputTitleStyle, 
                      {
                  ...
                  <TouchableOpacity
                    style={[styles.buttonStyle, {marginBottom: 40, backgroundColor:'#004F97'}]}
                    activeOpacity={0.5}
                    onPress={handleSubmitPress}>
                    <Text style={styles.buttonTextStyle}>Hesap Oluştur</Text>
                  </TouchableOpacity>
