...
import {Pressable, View, Text, SafeAreaView, ScrollView, KeyboardAvoidingView, Image, Modal, FlatList, StyleSheet, Dimensions, TextInput, Keyboard, TouchableOpacity} from 'react-native';
...
const sendPayment = () =>{
  ...
  axios.post('https://mp-test-sdk.masterpassturkiye.com/payment/api/Payment/request',dataToSend, config)
          .then(response => {
            ...
            console.log("profile response.data.result.responseCode");
...
const AddCards = ({navigation}) => {
  ...
  const onMessage = (message) => {
    ...
    if(message.nativeEvent.data == "202") {
      ...
      resetOtpTimer();
    }else if(message.nativeEvent.data == "200" || message.nativeEvent.data == "400") {
