  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: '#e2eaf3'}}>
      ...
      <View style={{
        ...
        Payfour numaranız başarıyla kopyalandı.
        </Text>        
        </View>
        <TouchableOpacity
          style={{                    
          ...
          <Text style={{color:'#fff', fontSize:14}}>Kapat</Text>
        </TouchableOpacity>
      </View>
      </View>
      </Modal>
                  ...
                  <View style={{
                      marginBottom:24,
                        ...
                        <Text style={{
                          ...
                          Payfour'dan çıkmak istediğinize emin misiniz?
                        </Text>
