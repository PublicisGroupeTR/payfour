            ...
            <View style={{paddingBottom:20}}>
              <View style={{
                ...
                <View style={{
                  ...
                  style={{
                    width:campaignDetailData.barLines.length > 0 ? (Dimensions.get('window').width - 48) / (campaignDetailData.barLines.length-1) * campaignDetailData.memberCurrentCount :0,
                    height:8,
                ...
                <View style={{
                  ...
                  return (
                    ...
                    style={{
                      ...
                      left: campaignDetailData.barLines.length > 0 ? (Dimensions.get('window').width - 48) / (campaignDetailData.barLines.length-1) * campaignDetailData.barLines[key].point : 0,
                      height:8,
                      width:1,
                      backgroundColor: '#fff'
                    }}>
                ...
                <View style={{
                  ...
                  return (
                    ...
                    style={{
                      ...
                      top:0,
                      //left:20 * campaignDetailData.barLines[key].point,
                      left: (Dimensions.get('window').width - 48) / (campaignDetailData.barLines.length-1) * campaignDetailData.barLines[key].point,
                      height:8,
                      width:1,
                      backgroundColor: '#fff'
                    }}>
                ...
                }}>
                {
                  ...
                  return (
                    ...
                    style={{
                      ...
                      top:20,
                      //left:20 * campaignDetailData.barLines[key].point,
                      left: (Dimensions.get('window').width - 56) / (campaignDetailData.barLines.length-1) * campaignDetailData.barLines[key].point,
                      height:16,
                      width:12,
                    }}>
                      <Text style={{
