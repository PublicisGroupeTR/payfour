                  ...
                  <View style={{flexDirection:'column', alignItems:'flex-start', justifyContent:'space-between'}}>
                    <View>
                      ...
                      <View style={{flexDirection:'row',alignItems:'flex-end',}}>
                        ...
                        style={{color:'#0B1929', fontSize:32, fontWeight:'700'}}>
                          {balance}
                      ...
                      <View style={{
                        ...
                        <View style={{
                          ...
                          return (
                            ...
                            <View key={"a"+campaignDetailData.barLines[key].key}
                            style={{
                              position:'absolute',
                              top:0,
                        ...
                        }}>
                        {
                          ...
                          return (
                            ...
                            <View key={"c"+campaignDetailData.barLines[key].key}
                            style={{
                              position:'absolute',
                              top:20,
                              //left:20 * campaignDetailData.barLines[key].point,
            ...
            <LinearGradient colors={['#067FC4', '#431836']} style={styles.linearGradient}>
              <View style={{paddingLeft:16, paddingRight:16, paddingTop:16, paddingBottom:16}}>
                ...
                <View style={[slstyles.slider, {marginBottom:16}]} {...slider.containerProps}>
                {
                  ...
                  return (
                    pslData.length > 0 ? 
                    <View key={"d"+pslData[key].uid} {...slider.slidesProps[key]}>
            ...
            <View style={{paddingLeft:16, paddingRight:16, paddingTop:16, paddingBottom:16}}>
              ...
              <View style={{}}>
                <View style={slstyles.slider} {...slider2.containerProps}>
                {
                    ...
                    return (
                      slData.length > 0 ? 
                      <View key={"e"+slData[key].uid} {...slider2.slidesProps[key]}>
                        <View style={{...slstyles.slide}}>
                        <TouchableOpacity onPress={() => {
