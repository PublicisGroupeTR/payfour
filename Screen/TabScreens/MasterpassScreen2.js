            ...
            <View
              ...
              <View
                style={{
                  ...
                  <View style={[regstyles.registerInputStyle, {borderColor: '#EBEBEB',height:60,lineHeight:60}]}>            
                    <TextInput
                      style={{                      
                        fontSize: 14,
                        lineHeight:18, 
          ...
          <View style={{
            ...
            <Text style={{fontSize:12, color:'#909EAA'}}>
              {maskedCardNumber}
                  ...
                  <View style={[regstyles.registerInputStyle, {borderColor: '#EBEBEB',paddingBottom:0,height:60, paddingTop:28}]}>                     
                    <Text style={{                                           
                        fontSize: 12,
                        lineHeight:12, 
                        padding:0,
