       ...
       source={require('../../assets/img/export/hazir_limit_bg.png')}>
        ...
        activeDot={
          ...
          <View style={istyles.bottomTextHolder}>
            ...
            Payfour Hazır Limit; CarrefourSA alışverişlerinizde kullanabilmeniz için size özel olarak belirlenen şimdi alıp ödemesini daha sonra gerçekleştirebileceğiniz hizmetimizdir.
            </Text>
            <Text style={[istyles.bottomText, {fontSize:14}]}>
            Payfour hazır limitiniz, nakit kullanmak istemediğinizde, kredi kartınız yoksa ya da limitlerinizi kullanmak istemediğinizde alışverişlerinizi şimdi yapıp daha sonra ödemenizi sağlar.
            </Text>
          </View>
          </View>
        ...
        <View style={istyles.bottomTextHolder}>
            ...
            Kullandığınız hazır limitlerinizin geri ödemesini size sunulan seçenekler arasından dilediğiniz taksit ve vade seçeneğine göre yapabilirsiniz.
            </Text>
          </View>
            <View>
            <TouchableOpacity
