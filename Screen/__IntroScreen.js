    ...
    setTimeout(() => {
      ...
      /*AsyncStorage.getAllKeys((err, keys) => {
        AsyncStorage.multiGet(keys, (err, stores) => {
          ...
          console.log("storage");
          console.log(obj);
          if (obj.phone !== 'null' && obj.uniqueMPANumber !== 'null'){
       ...
       source={require('../assets/img/export/tutorial_bg.png')}>
        ...
        activeDot={
          ...
          <View style={styles.bottomTextHolder}>
            ...
            Artık <Text style={{fontWeight:'700'}}>CarrefourSA </Text>alışverişlerin sana özel kampanyalar ve finansal çözümler ile hem daha eğlenceli hem de daha kazançlı olacak
            </Text>
          </View>
          </View>
          <View style={styles.slide2}>
            <View style={styles.header}>
              <Text style={styles.text}>%5 Nakit İade!</Text>
            </View>
            <Image
        ...
        <View style={styles.bottomTextHolder}>
            <Text style={[styles.bottomText, {fontSize:18}]}>
            Alışverişlerini Payfour ile öde, her ödemende <Text style={{fontWeight:'700'}}>%5 nakit iade  </Text>kazan. 
            </Text>
          </View>
          </View>
          <View style={styles.slide3}>
            <View style={styles.header}>
              <Text style={styles.text}>Harca Kazan!</Text>
            </View>
            <Image
        ...
        <View style={styles.bottomTextHolder}>
            ...
            <Text style={{fontWeight:'700'}}>Payfour </Text> ile ödeyeceğin her alışveriş ile puan kazanabilir, bir sonraki alışverişinde bu puanları dilediğin gibi harcayabilirsin.
            </Text>
          </View>
          </View>
        ...
        <View style={styles.bottomTextHolder}>
            <Text style={styles.bottomText}>
            <Text style={{fontWeight:'700'}}>Payfour </Text> ile yapacağın alışverişlerde, hemen hazır limitini öğrenebilir ve anında kredi kullanabilirsin. Üstelik ödemesi en kolay taksit seçenekleri ile.
            </Text>
          </View>
          </View>
        </Swiper>
