      ...
      <View style={styles.main}>
        <View style={styles.container}>
          <View style={styles.content}>
            ...
            <Image
              source={require('../../assets/img/kyc_ocr_info.png')}
              style={styles.image}
            />
            <Text style={styles.title}>Kimliğini kameraya okut</Text>
            <Text style={styles.text}>Bilgilerini okuyabilmesi için kimlik kartını telefonunun kamerasına göster.</Text>
          </View>
