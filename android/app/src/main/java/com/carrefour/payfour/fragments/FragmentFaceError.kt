...
class FragmentFaceError : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        return inflater.inflate(R.layout.fragment_face_error, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        subtabHeaderTitle.text = "Yüzünü Tanıt"

        val retryButton: Button = view.findViewById(R.id.retryButton)
        val cancelButton: LinearLayout = view.findViewById(R.id.cancelButton)
    ...
    public fun retryButtonClick() {
        (activity as? EnQualifyActivity)?.retryFaceDetect()
    }
